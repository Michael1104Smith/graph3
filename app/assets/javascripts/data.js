    ...
    g.extend(p.prototype, {
        ...
        getColumnDistribution: function() {
            ...
            k(a && a.seriesMapping || [], function(a) {
                var e = new j,
                    o, q = c[n] || f(d),
                    m = g.seriesTypes[((b && b.series || [])[n] || {}).type || d || "line"].prototype.pointArrayMap || ["y"];
        ...
        parseCSV: function() {
            var b = this,
                ...
                h = a.startColumn || 0,
                n = a.endColumn || Number.MAX_VALUE,
                i, g, s = 0;
        ...
        parseGoogleSpreadsheet: function() {
            ...
            e && jQuery.ajax({
                ...
                success: function(a) {
                    ...
                    for (l = 0; l < m; l++)
                        if (l >= h && l <= n) f[l - h] = [], f[l - h].length = Math.min(j, c - d);
                    for (l = 0; l < k; l++)
        ...
        parseColumn: function(b, a) {
            var e = this.rawColumns,
                f = this.columns,
                d = b.length,
                c, h, g, i, k = this.firstRowAsNames,
                j = r(a, this.valueCount.xColumns) !==
                -1,
                o = [],
                q = this.chartOptions,
                m, p = (this.options.columnTypes || [])[a],
                q = j && (q && q.xAxis && u(q.xAxis)[0].type === "category" || p === "string");
            for (e[a] || (e[a] = []); d--;)
                if (c = o[d] || b[d], g = this.trim(c), i = this.trim(c, !0), h = parseFloat(i), e[a][d] === void 0 && (e[a][d] = g), q || d === 0 && k) b[d] = g;
            ...
            if (j && m && this.options.sort)
                for (a = 0; a < f.length; a++) f[a].reverse(), k && f[a].unshift(f[a].pop())
        },
        dateFormats: {
            "YYYY-mm-dd": {
            ...
            afterComplete: function(d) {
                ...
                if (a.hasOwnProperty("series"))
                    if (typeof a.series === "object")
                        for (c = Math.max(a.series.length, d.series.length); c--;) h = a.series[c] || {}, a.series[c] = g.merge(h, d.series[c]);
